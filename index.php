    ...
    <div class="container">
        ...
        <!-- PAGAMENTO VIA CARTÃO -->
            <div class="col-md-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="./example2/pay.php" method="POST">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="./example2/pay_boleto.php" method="POST">
                          <div class="row">
                            <div class="col-xs-12">
                            <input type="hidden" name="senderHash">
        ...
        <div class="col-md-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="./example2/pay_debito.php" method="POST">
                          <div class="row">
                            <div class="col-xs-12">
                            <input type="hidden" name="senderHash">
